...
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarMat3 spatialExpWZ(T q,const T* dq,const T* ddq,TX* X=NULL,TS* S=NULL,TV* vJ=NULL,TV* dvJ=NULL,TD* DvJDq=NULL,TD* DdvJDq=NULL,TD* DdvJDdq=NULL)
{
...
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarMat3 spatialExpWYZ(const TCV& q,const TCV* dq,const TCV* ddq,TX* X=NULL,TS* S=NULL,TV* vJ=NULL,TV* dvJ=NULL,TD* DvJDq=NULL,TD* DdvJDq=NULL,TD* DdvJDdq=NULL)
{
  //this is a special type of Euler-Angle in favor of our definition in RootInvariantMLP
  T sy,cy,sz,cz;
...
FORCE_INLINE EIGEN_DEVICE_FUNC void spatialExpWYZDSTDqf(const TCV& q,TTAU& DSTDqTf,const TF& f)
{
  T sy,cy;
  SinCosTraits<T>::sincos(q[0],&sy,&cy);
...
template <typename T,typename TCV,typename TTAU,typename TF>
FORCE_INLINE EIGEN_DEVICE_FUNC void spatialExpWYZDSDqf(const TCV& q,TTAU& DSTDqf,const TF& f)
{
  T sy,cy;
  SinCosTraits<T>::sincos(q[0],&sy,&cy);
  DSTDqf(0,0)-=f[1]*cy;
...
template <typename T,typename TCV,typename TV,typename TX,typename TS,typename TD>   //rotation 3D euler angle
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarMat3 spatialEulerX1Y3Z2(const TCV& q,const TCV* dq,const TCV* ddq,TX* X=NULL,TS* S=NULL,TV* vJ=NULL,TV* dvJ=NULL,TD* DvJDq=NULL,TD* DdvJDq=NULL,TD* DdvJDdq=NULL)
{
  //this is a special type of Euler-Angle in favor of our definition in RootInvariantMLP
  T sx,cx,sy,cy,sz,cz;
...
template <typename T,typename TCV,typename TTAU,typename TF>
FORCE_INLINE EIGEN_DEVICE_FUNC void spatialEulerX1Y3Z2DSTDqf(const TCV& q,TTAU& DSTDqTf,const TF& f)
{
  T sx,cx,sz,cz;
  SinCosTraits<T>::sincos(q[0],&sx,&cx);
  SinCosTraits<T>::sincos(q[2],&sz,&cz);
...
template <typename T,typename TCV,typename TTAU,typename TF>
FORCE_INLINE EIGEN_DEVICE_FUNC void spatialEulerX1Y3Z2DSDqf(const TCV& q,TTAU& DSTDqf,const TF& f)
{
  T sx,cx,sz,cz;
  SinCosTraits<T>::sincos(q[0],&sx,&cx);
  SinCosTraits<T>::sincos(q[2],&sz,&cz);
...
template <typename T,typename TCV,typename TV,typename TX,typename TS,typename TD>   //rotation 3D euler angle
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarMat3 spatialExpW(const TCV& q,const TCV* dq,const TCV* ddq,TX* X=NULL,TS* S=NULL,TV* vJ=NULL,TV* dvJ=NULL,TD* DvJDq=NULL,TD* DdvJDq=NULL,TD* DdvJDdq=NULL)
{
...
template <typename T,typename TCV,typename TTAU,typename TF>
FORCE_INLINE EIGEN_DEVICE_FUNC void spatialExpWDSTDqf(const TCV& q,TTAU& DSTDqTf,const TF& f)
{
  typedef typename ScalarUtil<T>::ScalarVec3 Vec3T;
...
template <typename T,typename TCV,typename TTAU,typename TF>
FORCE_INLINE EIGEN_DEVICE_FUNC void spatialExpWDSDqf(const TCV& q,TTAU& DSTDqf,const TF& f)
{
  typedef typename ScalarUtil<T>::ScalarVec3 Vec3T;
  Vec3T diffV[3],ddiffV[9];
  typename ScalarUtil<T>::ScalarMat3 R=expWGradV<T,Vec3T>(q,diffV,ddiffV);
...
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC void debugSpatialRotation()
{
