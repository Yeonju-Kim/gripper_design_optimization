...
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC void debugCross()
{
...
//spatial
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarMat6 toSpatial(const typename ScalarUtil<T>::ScalarMat3X4 t)
{
...
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarMat3X4 fromSpatial(const typename ScalarUtil<T>::ScalarMat6 t)
{
...
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarMat6 spatialCross(const typename ScalarUtil<T>::ScalarVec6& v)
{
  typename ScalarUtil<T>::ScalarMat6 ret;
  ret.setZero();
...
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarVec6 spatialCross(const typename ScalarUtil<T>::ScalarVec6& v,const typename ScalarUtil<T>::ScalarVec6& w)
{
...
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarMat6 spatialCrossStar(const typename ScalarUtil<T>::ScalarVec6& v)
{
  typename ScalarUtil<T>::ScalarMat6 ret;
  ret.setZero();
...
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarVec6 spatialCrossStar(const typename ScalarUtil<T>::ScalarVec6& v,const typename ScalarUtil<T>::ScalarVec6& w)
{
  typename ScalarUtil<T>::ScalarVec6 ret;
...
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarMat6 spatialXStar(const typename ScalarUtil<T>::ScalarMat6& X)
{
  typename ScalarUtil<T>::ScalarMat6 ret;
  ret.setZero();
...
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarMat6 spatialInv(const typename ScalarUtil<T>::ScalarMat6& X)
{
  typename ScalarUtil<T>::ScalarMat6 ret;
  ret.setZero();
...
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarVec3 spatialVel(const typename ScalarUtil<T>::ScalarVec6& V,const typename ScalarUtil<T>::ScalarVec3& v)
{
  return V.template segment<3>(0).cross(v)+V.template segment<3>(3);
}
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarVec3 applyTrans(const typename ScalarUtil<T>::ScalarMat3X4& X,const typename ScalarUtil<T>::ScalarVec3& v)
{
  return X.template block<3,3>(0,0)*v+X.template block<3,1>(0,3);
}
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarVec3 applyTransInv(const typename ScalarUtil<T>::ScalarMat3X4& X,const typename ScalarUtil<T>::ScalarVec3& v)
{
  return X.template block<3,3>(0,0).transpose()*(v-X.template block<3,1>(0,3));
}
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarVec3 spatialApplyTrans(const typename ScalarUtil<T>::ScalarMat6& X,const typename ScalarUtil<T>::ScalarVec3& v)
{
  return applyTrans<T>(fromSpatial<T>(X),v);
}
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC typename ScalarUtil<T>::ScalarVec3 spatialApplyTransInv(const typename ScalarUtil<T>::ScalarMat6& X,const typename ScalarUtil<T>::ScalarVec3& v)
{
  return applyTrans<T>(fromSpatial<T>(spatialInv<T>(X)),v);
}
template <typename T>
FORCE_INLINE EIGEN_DEVICE_FUNC void debugSpatial()
{
