...
if __name__=='__main__':
    ...
    #cup3, grasp from inside
    design={'base_off':0.2,'finger_length':0.15,'finger_width':0.2,'finger_curvature':4.,'num_finger':3,'hinge_rad':0.06}
    policy={'angle':[0.,math.pi*0.99/2,math.pi/2],'init_dist':3.5,'init_pose':[-.1,0.],'approach_coef':[-1.,-1.]}
    controller={'lift_height':2.5}
    test_dataset_canonical(design,policy,controller,ids=[7])
    ...
    policy={'angle':[0.,math.pi*0.99/2,math.pi],'init_dist':3.5}
    controller={'lift_height':2.5}
    ...
    policy={'angle':[0.,math.pi*0.99/2,math.pi],'init_dist':3.5,'init_pose':[-.2,0.1],'approach_coef':[-1.,-1.]}
    controller={'lift_height':2.5}
