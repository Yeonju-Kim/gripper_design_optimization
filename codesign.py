...
class BehaviorSpace:
    ...
    def validSamples(self, design, environment, behSampleSize, maxTrial):
        """Returns valid behavior samples with size=behSampleSize. Use self.randomSample
        to generate a behavior candidate and check if (design, behSample) is valid.
        ...
        Args:
            ...
            environment (user-defined): the environment in which the behavior
                should be tested.
            behSampleSize (int): length of behavior samples
            maxTrial (int): max # of behavior candidates generated by self.randomSample
        """
        raise NotImplementedError()
